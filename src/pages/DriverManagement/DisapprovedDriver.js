...
export default function DriverManagement(props) {
  ...
  const handleChangePage = (event, newPage) => {
    ...
    getCategoriesContent(newPage + 1, rowsPerPage, ServiceTypeId, ActiveInactiveDuty, "disapproved", search);
    // setPage(newPage + 1);
  };
  ...
  const handleChangeRowsPerPage = (event) => {
    ...
    // setPage(0);
    getCategoriesContent(0, event.target.value, ServiceTypeId, ActiveInactiveDuty, "disapproved", search);
  ...
  const ViewDriverData = (data) => {
    let apiHit = {
      ...
      pathname: "/adminPanel/DisapprovedDriver",
    };
    props.history.push({
          ...
          <Paper elevation={0} style={{ backgroundColor: "transparent" }}>
            <div className={classes.paperPaddingRightLeft}>
              <div className="">
                ...
                >
                  {" "}
                  {/* <Tooltip title={<span style={{ color: "white", fontSize: "16px" }}>Search</span>} arrow>
                      <IconButton
                        className="buttoncss"
                        style={{ backgroundColor: showSearch ? "navy" : "#006FFF", color: "#fff" }}
                        onClick={() => {
                  ...
                  {/* <Tooltip title={<span style={{ color: "white", fontSize: "16px" }}>Filter</span>} arrow>
                      <IconButton
                        className="buttoncss"
                        style={{ backgroundColor: showFilter ? "navy" : "#006FFF", color: "#fff" }}
                        onClick={() => {
                  ...
                  <div>
                      {" "}
                      <Tooltip
                        title={<span style={{ color: "white", fontSize: "16px" }}>Delete All Disapproved Drivers</span>}
                        arrow
                      >
                        <IconButton
                          className="buttoncss"
                ...
                {/* status end */}
                <Paper elevation={0} style={{ backgroundColor: "transparent", position: "relative", zIndex: 3 }}>
