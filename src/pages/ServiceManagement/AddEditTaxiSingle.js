...
const AddEditTaxiSingle = (props) => {
  ...
  const EditTaxiSingle = async (values) => {
    try {
      ...
      const { data } = await axios.put(`/private/vehicleCategory/${state._id}`, {
                ...
                <Paper elevation={0} className={classNames(classes.paperHeading, classes.addNewCategory)}>
                  ...
                  <div className={classNames(classes.addNewCategoryHeading)}>
                    ...
                    <h3 className={classNames(classes.MarginControl)} style={{ marginBottom: "-0.5rem", marginLeft: "-135px" }}>
                      {console.log(state)}
                      {!state ? `ADD VEHICLE TYPE` : `EDIT VEHICLE TYPE`}
                    </h3>
                  </div>
                </Paper>
                      ...
                      {({ values, setFieldValue }) => (
                        <Form>
                          ...
                          <div className="row my-5 align-items-center">
                            <div className="col-4">
                              <label className="labelAddCategory" style={{ fontSize: "18px" }}>
                                {!state ? `Vehicle Description` : `Vehicle Description`} :
                              </label>
                            </div>
                            <div className="col-8 d-flex flex-column">
                              <Field
...
export default AddEditTaxiSingle;
