...
const AddEditCancellation = (props) => {
  ...
  const validationSchema = yup.object({
    ...
    English: yup.string().min(5, "too small!").max(20, "Too Long String!").required("Required!"),
    Korean: yup.string().min(5, "too small!").max(20, "Too Long String!").required("Required!"),
    Chinese: yup.string().min(5, "too small!").max(20, "Too Long String!").required("Required!"),
    Spanish: yup.string().min(5, "too small!").max(20, "Too Long String!").required("Required!"),
  ...
  const EditCancellationReasons = async (values) => {
    try {
      ...
      const { data } = await axios.put(`/private/cancelReason/${state._id}`, {
        // message: values.,
                ...
                <Paper elevation={0} className={classNames(classes.paperHeading, classes.addNewCategory)}>
                  ...
                  <div className={classNames(classes.addNewCategoryHeading)}>
                    ...
                    <h3 className={classNames(classes.MarginControl)} style={{ marginBottom: "-0.5rem", marginLeft: "-135px" }}>
                      {console.log(state)}
                      {!state ? `Add Cancellation Reason` : `Edit Cancellation Reason`}
                    </h3>
                  </div>
                </Paper>
